...
<head>
    ...
    <title>Fonarte Latino | Categorias</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header tipografia2"><i class="fa fa-tags" aria-hidden="true"></i>&nbsp;Categor&iacute;as
                    <small>&nbsp;</small>
            </div>
        </div>
  ...
  <!--h3 class="tipografia2">Agregar Categor�as</h3-->             
<div class="row">
...
<tbody>
    ...
    <tr class="letra_admin_prod2">
        <td><?php echo $row_Categoria['id']; ?></td>
...
<!-- inicio de Modal -->
<div class="modal fade" id="edita_categoria" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content" id="contenido_categoria">
...
function carga_modal_1(id_cateoria)
{
	//alert(id_cateoria+'---')
	$( "#contenido_categoria" ).load( "ajax_contenido_categoria.php?id_cateoria="+id_cateoria);
}
