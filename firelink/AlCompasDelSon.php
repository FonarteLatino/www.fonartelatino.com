<!DOCTYPE html>
<html>
    <?php $ruta_imagen = "../img/caratulas/alCompas.jpeg";
     $nombreArtista = "Al Compas del Son";
     $Album = "playlist";
     $fonarte = ""; 
     $spotify = "https://open.spotify.com/user/fonarte/playlist/0N6QexJ8O3vniQ75NrSTb8?si=YYJZchANR0WgjZjk3C_F0Q"; 
     $appleItunes = ""; 
     $youtube = "https://music.youtube.com/playlist?list=PLc4yDYeqDnyWpfrptce4JwsrpEm7CGzD9"; 
     $google = ""; 
     $claro = ""; 
     $amazon = "";
     $deezer = "https://www.deezer.com/mx/playlist/5436979362"; 
     $video = "";
     $play = 1?>
<head>
