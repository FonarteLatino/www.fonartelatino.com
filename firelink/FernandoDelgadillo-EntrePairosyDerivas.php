...
<html>
    <?php
    header('Location: https://www.fonartelatino.com/firelink/321/Fernando_Delgadillo-untre_Pairos_y_Derivas');
     $tipo = 2;
      if ($tipo == 0) {
     ...
     $ruta_imagen = $ruta_imagen."CDDP-1175.jpg";
     $nombreArtista = "Fernando Delgadillo";
     $Album = "Entre Pairos y Derivas";
     $description = "";
     $fonarte = "https://www.fonartelatino.com/producto_detalle/321/fernando_delgadillo-entre_pairos_y_derivas"; 
     $spotify = "https://open.spotify.com/album/0Dm8kFxZeLSQNTOcF4ZCIQ?si=h4c8Ih8ATjqH_QAjhSKmZQ"; 
     $appleItunes = "https://itunes.apple.com/mx/album/id353213342"; 
     $youtube = "https://music.youtube.com/playlist?list=OLAK5uy_nEVrJBFENWSGFpqpdJIiVGX1Hf7_8wDgo"; 
     $google = "https://play.google.com/store/music/album/Fernando_Delgadillo_Entre_Pairos_y_Derivas?id=Bds3t4xvyiwcyzrpquw7dnldlk4"; 
     $claro = "https://www.claromusica.com/album/236654"; 
     $amazon = "https://www.amazon.com/Entre-Pairos-Derivas-Fernando-Delgadillo/dp/B003BUPHWM/ref=sr_1_13?s=dmusic&ie=UTF8&qid=1485542313&sr=1-13&keywords=Fernando+Delgadillo&refinements=p_n_feature_browse-bin%3A625150011";
     $deezer = "https://www.deezer.com/mx/album/1110481"; 
     $video = "";
     $play = 0?>
<head>
