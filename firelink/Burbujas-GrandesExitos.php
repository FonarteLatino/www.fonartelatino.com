...
<html>
    <?php
    header('Location: https://www.fonartelatino.com/firelink/105/Burbujas-Grandes_%EF%BF%BDxitos');
     $tipo = 2;
      if ($tipo == 0) {
     ...
     $ruta_imagen = $ruta_imagen."CDDP-7409.jpg";
     $nombreArtista = "Burbujas";
     $Album = "Grandes éxitos";
     $description = "";
     $fonarte = "https://www.fonartelatino.com/producto_detalle/105/burbujas-grandes_exitos"; 
     $spotify = "https://open.spotify.com/album/4GbqyjZUEk8FsWUrOvi4Tx?si=pwl-IUxLQ4Oea4sp8by_Jw"; 
     $appleItunes = "https://itunes.apple.com/mx/album/grandes-exitos/id1129419653?l=en"; 
     $youtube = "https://music.youtube.com/playlist?list=OLAK5uy_n1QyfBswtitOx7BrqH1D2OutQeZ0Hmqz0"; 
     $google = "https://play.google.com/store/music/artist/Burbujas?id=Ap3ntubghp2iy32eerog7idiz2i&hl=es"; 
     $claro = "https://www.claromusica.com/album/1713988"; 
     $amazon = "https://www.amazon.com/Grandes-%EF%BF%BDxitos-Burbujas/dp/B01HS07UL6/";
     $deezer = "https://www.deezer.com/mx/album/13473075"; 
     $video = "";
     $play = 0?>
<head>
