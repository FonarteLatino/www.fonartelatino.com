...
<html>
    <?php
     ...
     $ruta_imagen = $ruta_imagen."MusicaLatinoamericana.jpeg";
     $nombreArtista = "";
     $Album = "";
     $description = "";
     $fonarte = ""; 
     $spotify = "https://open.spotify.com/user/fonarte/playlist/5iYSEofDjIleYgUtTIjv09?si=qdlpYvqNRR6q16_T0jv7DA"; 
     $appleItunes = ""; 
     $youtube = "https://music.youtube.com/playlist?list=PLc4yDYeqDnyUDjxUBfNAANpdvuITQWX15"; 
     $google = ""; 
     $claro = ""; 
     $amazon = "";
     $deezer = "https://www.deezer.com/mx/playlist/5560133322"; 
     $video = "";
     $play = 1?>
<head>
