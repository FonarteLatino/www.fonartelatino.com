...
<html>
    <?php
    header('Location: https://www.fonartelatino.com/firelink/319/Fernando_Delgadillo-Desde_la_rsla_del_olvido');
     $tipo = 2;
      if ($tipo == 0) {
     ...
     $ruta_imagen = $ruta_imagen."CDFL-1441.jpg";
     $nombreArtista = "Fernando Delgadillo";
     $Album = "Desde la Isla del Olvido";
     $description = "";
     $fonarte = "https://www.fonartelatino.com/producto_detalle/319/fernando_delgadillo-desde_la_isla_del_olvido"; 
     $spotify = "https://open.spotify.com/album/0q1SQuO9fPe1uLZIohnvrj?si=0OG7Rh2oSHOd1BDnNlT5Ow"; 
     $appleItunes = "https://itunes.apple.com/mx/album/id353136853"; 
     $youtube = "https://music.youtube.com/playlist?list=OLAK5uy_lsg6LsOXfoGt2_V9JVCutj5a1ViTr7BKA"; 
     $google = "https://play.google.com/store/music/album/Fernando_Delgadillo_Desde_la_Isla_del_Olvido?id=Btzrycowmuhrkepihy3h5rpwmeu"; 
     $claro = "https://www.claromusica.com/album/236821"; 
     $amazon = "https://www.amazon.com/Desde-Isla-Olvido-Fernando-Delgadillo/dp/B003BS4UXG/ref=sr_1_10?s=dmusic&ie=UTF8&qid=1485542313&sr=1-10&keywords=Fernando+Delgadillo&refinements=p_n_feature_browse-bin%3A625150011";
     $deezer = "https://www.deezer.com/mx/album/6290609"; 
     $video = "";
     $play = 0?>
<head>
