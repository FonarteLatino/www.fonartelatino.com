...
<html>
    <?php
    header('Location: https://www.fonartelatino.com/firelink/454/La_Barranca-Rueda_de_los_Tiempos');
     $tipo = 2;
      if ($tipo == 0) {
     ...
     $ruta_imagen = $ruta_imagen."CDDR-4015.jpg";
     $nombreArtista = "La Barranca";
     $Album = "Rueda de los Tiempos";
     $description = "";
     $fonarte = ""; 
     $spotify = "https://open.spotify.com/album/2PfgYyfpnGWyuWzYkrgohy?si=B03fjKynT-q5WDeTYRuLeg"; 
     $appleItunes = "https://itunes.apple.com/mx/album/rueda-los-tiempos-bonus-version/id146756427"; 
     $youtube = "https://music.youtube.com/playlist?list=OLAK5uy_nLHqiwS-yH_jb4RXCyp4yIL4EXgoeIpyQ"; 
     $google = "https://play.google.com/store/music/album/La_Barranca_Rueda_de_los_Tiempos?id=B73ustyqw3tv6k7z4ldwyehqhkq"; 
     $claro = "https://www.claromusica.com/album/237040"; 
     $amazon = "https://www.amazon.com/Rueda-los-Tiempos-Barranca/dp/B000QZU626/ref=sr_1_1?s=dmusic&ie=UTF8&qid=1485545642&sr=1-1-mp3-albums-bar-strip-0&keywords=Rueda+de+los+Tiempos";
     $deezer = "https://www.deezer.com/mx/album/1102866"; 
     $video = "";
     $play = 0?>
<head>
