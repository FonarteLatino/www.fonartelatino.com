<!DOCTYPE html>
<html>
    <?php $ruta_imagen = "../img/caratulas/cantautores.jpeg";
     $nombreArtista = "Cantautores A La Carta";
     $Album = "playlist";
     $fonarte = ""; 
     $spotify = "https://open.spotify.com/user/fonarte/playlist/1YdijWLKixSQmKwjVeY3jF?si=Z9Q0TANsQU6YqEntto6ESA"; 
     $appleItunes = ""; 
     $youtube = "https://music.youtube.com/playlist?list=PLc4yDYeqDnyUEmbFhcyM7c2HLGaSTVnUE"; 
     $google = ""; 
     $claro = ""; 
     $amazon = "";
     $deezer = "https://www.deezer.com/playlist/5473168142?utm_source=deezer&utm_content=playlist-5473168142&utm_term=2582078102_1550006181&utm_medium=web"; 
     $video = "";
     $play = 1?>
<head>
            ...
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4" style="background-color: white; display:inline-block; opacity: 0.8; filter: alpha(opacity=80);">
                ...
                <div style="border:solid 1.5px #000; border-radius:15px; box-shadow: 8px 8px 10px 0px #818181;">
                    ...
                    <?php if ($play != 0) {
                        ...
                        echo "<div class=\"row\">
                                <center><iframe src=\"https://open.spotify.com/embed/user/fonarte/playlist/".$ssaux[1]."\" width=\"250\" height=\"350\" frameborder=\"0\" allowtransparency=\"true\" allow=\"encrypted-media\"></iframe></center>
                            </div>";
                    } ?>
                    <br>
                </div>
