...
<head>
   ...
   <meta charset="ISO-8859-1" />
    ...
    <title>Fonarte Latino | Precios Productos</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header tipografia2"><i class="fa fa-money" aria-hidden="true"></i>&nbsp;Precios Productos
                    <small>&nbsp;</small>
            </div>
        </div>
  ...
  <h3 class="tipografia2">Agregar clave de precio</h3>             
<div class="row">
...
<tbody>
    ...
    <tr class="letra_admin_prod2">
        ...
        <td><?php echo "<strong>".$row_Precios['clave']."</strong> (".$totalRows_ProductosAsignados." productos asignados)"; ?></td>
...
<!-- inicio de Modal -->
<div class="modal fade" id="edita_precio" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content" id="contenido_precio">
...
function carga_modal_1(id_precio)
{
	//alert(id_precio+'---')
	$( "#contenido_precio" ).load( "ajax_contenido_precio.php?id_precio="+id_precio);
}
