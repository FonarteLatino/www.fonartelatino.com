...
?>
  ...
  <h3 class="tipografia2">Agregar Lanzamientos</h3>             
<div class="row">
    ...
    <div class="col-sm-5">
        ...
        {
        $('#id_nombre_lanzamientos').keyup(function()
        {
        var nombre_lanzamientos=$('#id_nombre_lanzamientos').val(); //declaramos las variables que vamos a mandar al siguiente php
        
        $('#variable3').load('js_despliega_art.php?nombre_lanzamientos='+nombre_lanzamientos);//enviamos las 2 variables
        });    
        });
        </script>
        <!--    FIN PARTE 2   -->
        ...
        <input type="text" name="nombre_lanzamientos" class="form-control" id="id_nombre_lanzamientos"  required > 
        </div>
