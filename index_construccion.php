...
<head>
    ...
    <title>Fonarte Latino | Construccion</title>
...
<body>
    ...
    <?php include("menu_construccion.php"); ?>
    ...
    <!-- Page Content -->
        ...
        <div class="row franja" >
            <div class="col-lg-12">
                <div class="container">
                    <p class="page-header">&nbsp;<small>&nbsp;</small></p>
                </div>
            </div>
        </div>
        </div>
...
<div class="container">
        ...
        <div class="row">
            ...
            <center>   
<div class="row">
    <div class="col-md-12 img-portfolio" style="min-height:230px;">
        
        <img class="img-responsive img-hover img-rounded" src="img/Construccion-700x525.jpg"   alt="" >
