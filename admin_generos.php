...
<head>
    ...
    <title>Fonarte Latino | Generos</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header tipografia2"><i class="fa fa-users" aria-hidden="true"></i>&nbsp;G&eacute;neros
                    <small>&nbsp;</small>
            </div>
        </div>
  ...
  <h3 class="tipografia2">Agregar G&eacute;nero</h3>             
<div class="row">
...
<!-- inicio de Modal -->
<div class="modal fade" id="edita_genero" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content" id="contenido_genero">
...
function carga_modal_1(id_genero)
{
	//alert(id_genero+'---')
	$( "#contenido_genero" ).load( "ajax_contenido_genero.php?id_genero="+id_genero);
}
